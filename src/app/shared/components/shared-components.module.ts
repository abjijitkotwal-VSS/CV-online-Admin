...
import {LogUotConfirmation} from '../services/app-confirm/LogOutConfirmation'

const components = [
  HeaderTopComponent,LogUotConfirmation,
  SidebarTopComponent,
  SidenavComponent,
...
@NgModule({
  ...
  entryComponents: [LogUotConfirmation,AppComfirmComponent, AppLoaderComponent, BottomSheetShareComponent],
  exports: components
})
