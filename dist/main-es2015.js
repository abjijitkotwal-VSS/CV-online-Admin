...
const rootRouterConfig = [
    ...
    },
    {
        ...
        children: [
            {
                path: 'sessions',
                loadChildren: () => Promise.all(/*! import() | views-sessions-sessions-module */[__webpack_require__.e("default~pages-pages-module~views-sessions-sessions-module"), __webpack_require__.e("views-sessions-sessions-module")]).then(__webpack_require__.bind(null, /*! ./views/sessions/sessions.module */ "./src/app/views/sessions/sessions.module.ts")).then(m => m.SessionsModule),
                data: { title: '' }
            }
        ]
    },
    {
        ...
        children: [
            {
                path: 'others',
                loadChildren: () => Promise.all(/*! import() | views-others-others-module */[__webpack_require__.e("default~pages-pages-module~views-others-others-module"), __webpack_require__.e("views-others-others-module")]).then(__webpack_require__.bind(null, /*! ./views/others/others.module */ "./src/app/views/others/others.module.ts")).then(m => m.OthersModule),
                data: { title: 'Others', breadcrumb: 'OTHERS' }
            },
            {
                path: 'pages',
                loadChildren: () => Promise.all(/*! import() | pages-pages-module */[__webpack_require__.e("default~pages-pages-module~views-others-others-module"), __webpack_require__.e("default~pages-pages-module~views-sessions-sessions-module"), __webpack_require__.e("pages-pages-module")]).then(__webpack_require__.bind(null, /*! ./pages/pages.module */ "./src/app/pages/pages.module.ts")).then(m => m.PagesModule),
...
let CustomLocationStrategy = class CustomLocationStrategy extends _angular_common__WEBPACK_IMPORTED_MODULE_1__["HashLocationStrategy"] {
...
let HeaderSideComponent = class HeaderSideComponent {
    constructor(themeService, layout, translate, renderer, CommonService, Auth, confirmService) {
        this.themeService = themeService;
        this.layout = layout;
...
let HeaderTopComponent = class HeaderTopComponent {
    constructor(layout, navService, themeService, translate, renderer) {
        this.layout = layout;
        this.navService = navService;
        this.themeService = themeService;
        this.translate = translate;
...
let SidebarSideComponent = class SidebarSideComponent {
    constructor(navService, themeService, layout, CommonService) {
        this.navService = navService;
        this.themeService = themeService;
        this.layout = layout;
        this.CommonService = CommonService;
...
let SidenavComponent = class SidenavComponent {
    ...
    formDataMaster(name, type, tooltip, icon, state) {
        const PageData = {};
        PageData.icon = icon;
        PageData.name = name;
    ...
    formData(name, type, tooltip, icon, state, sub) {
        const PageData = {};
        PageData.icon = icon;
        PageData.name = name;
        PageData.state = state;
...
let AppinterceptorService = class AppinterceptorService {
    ...
    intercept(req, next) {
        ...
        return next.handle(clone).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(error => {
            if (error.status === 401) {
                this.auth.loggedOut();
                throw error;
            }
...
let FileAppinterceptorService = class FileAppinterceptorService {
    constructor(auth) {
        this.auth = auth;
    }
    handlError(error) {
...
FileAppinterceptorService.ctorParameters = () => [
    { type: _MyServices_authorize_service__WEBPACK_IMPORTED_MODULE_3__["AuthorizeService"] }
];
...
let CommonService = class CommonService {
    ...
    // }
    BindRoleType(Data) {
        return this.http.post(this.RoletypeDrpDwn, '', { headers: { "Content-Type": "application/json" } }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(err => Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(err)));
    }
    BindPosition(Data) {
        return this.http.post(this.PositionDrpDwn, Data, { headers: { "Content-Type": "application/json" } }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(err => Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(err)));
    }
    RegistrationSave(Data) {
        return this.http.post(this.SaveRegistration, Data, { headers: { "Content-Type": "application/json" } }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(err => Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(err)));
    }
    RegistrationUpdate(Data) {
        return this.http.post(this.UpdateRegistrationUrl, Data, { headers: { "Content-Type": "application/json" } }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(err => Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(err)));
    }
    RegistrationList(Data) {
        return this.http.post(this.RegistrationListAPi, Data, { headers: { "Content-Type": "application/json" } }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(err => Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(err)));
    }
    Dashboard(Data) {
        return this.http.post(this.DashboardAPi, Data, { headers: { "Content-Type": "application/json" } }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(err => Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(err)));
    }
    DistributorList(Data) {
        return this.http.post(this.DistributorListAPi, Data, { headers: { "Content-Type": "application/json" } }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(err => Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(err)));
    }
    DivisionList(Data) {
        return this.http.post(this.DiVisionURL, Data, { headers: { "Content-Type": "application/json" } }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(err => Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(err)));
    }
...
let LogUotConfirmation = class LogUotConfirmation {
    constructor(dialogRef, data) {
        this.dialogRef = dialogRef;
        this.data = data;
    }
};
LogUotConfirmation.ctorParameters = () => [
